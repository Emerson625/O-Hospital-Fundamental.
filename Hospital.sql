...
INSERT into receita (id_receita, qnt_medicamentos, instr_medicamentos, medicamentos, medico_id, paciente_id) values (4, 'Caixa com 4 comprimidos revestidos', 'Tomar citrato de sildenafila por via oral (pela boca).', 'Citrato de Sildenafila Neo Química 50mg', 10, 2);
...
INSERT into receita (id_receita, qnt_medicamentos, instr_medicamentos, medicamentos, medico_id, paciente_id) values (8, 'Uma caixa com 1 frasco-ampola com pó para solução de uso intravenoso + 1 frasco-ampola com 10mL de solução estabilizante', 'A administração de Blincyto será feita por meio de uma veia (via intravenosa) continuamente por 4 semanas por uma bomba de infusão, seguida de uma pausa de 2 semanas durante a qual você não receberá a infusão (este é o ciclo de tratamento 1).', 'Blincyto 38,5mcg', 7, 8);
INSERT into receita (id_receita, qnt_medicamentos, instr_medicamentos, medicamentos, medico_id, paciente_id) values (9, 'Uma caixa com 1 frasco com 100mL de solução de uso intravenoso', 'A dose usual de Aclasta® é de 5 mg que será administrada por meio de uma única aplicação por ano, na veia pelo seu médico ou enfermeiro. A aplicação levará pelo menos 15 minutos.', 'Aclasta 5mg/100mL', 9, 15);
INSERT into receita (id_receita, qnt_medicamentos, instr_medicamentos, medicamentos, medico_id, paciente_id) values (10, 'caixa com 1 frasco-ampola', 'Botulim® deve ser injetado usando uma seringa estéril e agulha 27 a 30 gauge.', 'Botulim 100U', 4, 5);
